...
| [`0008-concurrent-storage-transactions.md`](0008-concurrent-storage-transactions.md) | Active; design only | Update with each concurrent-storage implementation unit that changes interfaces, ownership, provider coverage, migration, isolation or acceptance evidence; runtime work remains pending. |
