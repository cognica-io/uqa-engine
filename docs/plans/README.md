...
| [`0012-compressed-container-read-consistency.md`](0012-compressed-container-read-consistency.md) | Active | Keep compressed chunk metadata bound to its authenticated file through concurrent compaction and initial SQLite reads. |
