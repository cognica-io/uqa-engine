...
Status: Implementation in progress. Configuration/reference fixtures merged in [PR #157](https://github.com/cognica-io/uqa-engine/pull/157) as `95f278f0`, navigation metrics/PQ in [PR #158](https://github.com/cognica-io/uqa-engine/pull/158) as `4b14fb74`, node/page encodings in [PR #159](https://github.com/cognica-io/uqa-engine/pull/159) as `d9d78aad`, and generation metadata/codecs in [PR #160](https://github.com/cognica-io/uqa-engine/pull/160) as `3d96d662`; their feature branches are removed. Controlled readers/cache/sealing are in progress on `feature/diskann-page-readers`. The completion ledger remains twelve units: two complete, one in progress, nine pending. Implementation baseline: main `7faeabe3`, inspected on 2026-09-25. Physical foundations do not add SQL support or establish runtime acceptance.
...
| Page format and controlled readers | Configuration and independent fixtures | Storage, Core memory budgets | In progress: node/page codecs merged in PR #159 (`d9d78aad`) and generation metadata in PR #160 (`3d96d662`), with independent byte fixtures, owner tests, strict Clippy and full automatic review. Controlled readers, cache, memory staging and physical seals now have owner tests; final review/merge remains pending. |
