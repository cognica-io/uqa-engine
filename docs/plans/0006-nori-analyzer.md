...
| Portable dictionary bundle | `uqa-analysis`, proposed data crate | Complete model export | Deterministic versioned packer, strict loader, content identity, shared immutable resources, corruption tests, and package provenance | Verified codec and full-model reconstruction; resource distribution and package gates pending |
