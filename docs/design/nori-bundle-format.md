...
Status: Implemented dictionary codec and offline packer; tokenizer, analyzer registration, cross-binding resource delivery, and end-to-end search integration remain tracked in the [implementation plan](../plans/0006-nori-analyzer.md).
