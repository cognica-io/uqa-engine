...
| Routines | `CREATE FUNCTION`, `CREATE PROCEDURE`, `CREATE OR REPLACE`, volatility/null-input `ALTER FUNCTION` and `ALTER ROUTINE`, `DROP FUNCTION`, `DROP PROCEDURE`, `DO`, `CALL` |
