...
For an existing installation, follow the [0.2.2 upgrade guide](reference/10-upgrading.md), including its CHECK and NOT NULL inheritance changes, Rust AST fields, and CHECK catalog migration notes.
