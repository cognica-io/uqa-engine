...
| [Upgrading](10-upgrading.md) | Version 0.4.0 package selection, shared MVCC writers, persistent-format upgrades, PostgreSQL corrections, notification recovery, Rust API changes, and analyzer/index migration |
