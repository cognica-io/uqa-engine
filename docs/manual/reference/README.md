...
| [Upgrading](10-upgrading.md) | Version 0.3.8 package selection, JSONB extraction semantics, concurrent INSERT identities, encrypted notification sidecars, Nori features, Rust API and SQLite provider changes, and persistent analyzer/index migration |
