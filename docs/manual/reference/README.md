...
| [Upgrading](10-upgrading.md) | Version 0.2.2 package selection, SQL ownership and constraint fixes, the Python CLI fix, Rust storage API changes, and database migration |
