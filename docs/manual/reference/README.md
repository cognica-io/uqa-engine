...
| [Upgrading](10-upgrading.md) | Version 0.3.7 package selection, concurrent INSERT identities, encrypted notification sidecars, Nori features, Rust API and SQLite provider changes, and persistent analyzer/index migration |
