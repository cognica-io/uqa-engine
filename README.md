...
The development branch adds [data-modifying CTEs](docs/manual/sql/03-queries-and-dml.md#data-modifying-ctes) and the Rust [Simple Query API with PostgreSQL command completion](docs/manual/reference/02-rust-engine-api.md#simple-query-messages). These changes are recorded under [Unreleased](HISTORY.md#unreleased).
