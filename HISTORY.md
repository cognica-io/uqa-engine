...
- Advance the common MVCC record format to 41 so SQLite and redb reject development writers that cannot decode retained expression identities introduced from main. Atomic upgrades preserve database identities, histories, identifier allocations and commit receipts.
