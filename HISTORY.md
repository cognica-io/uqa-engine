...
- Routed bound native SQLite exact and IVF vector APIs through common logical sessions. Canonical tensors and IVF metadata publish atomically, retained snapshots survive rollback and lifecycle changes, and selected IVF reads avoid unrelated vector payloads. Shared-index merging and complete concurrent Engine SQL remain in progress.
