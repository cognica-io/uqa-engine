...
- **uqa-operators (Phase 1-2, 8, 9):** Operator trait with Boolean, hybrid, primitive, multi-stage, sparse, progressive-fusion, hierarchical, and ML-backed deep-fusion layers in `uqa-ml` (Embed / Signal / Dense / Flatten / GlobalPool / Softmax / BatchNorm / Dropout / CNN1D / CNN2D / RNN / LSTM / Propagate / Conv / Pool / Attention).
