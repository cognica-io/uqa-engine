...
See the [UQA Engine manual](https://github.com/cognica-io/uqa-engine/blob/v0.3.8/docs/manual/reference/08-bindings-and-extensions.md) for the complete Browser WASM binding contract.
