...
use uqa_storage::clustered_postings::{cluster_id, encode_cluster, encode_terms, ClusterPosting};
...
pub(in crate::catalog::migration) fn clustered_posting_tables_have_current_shape(
