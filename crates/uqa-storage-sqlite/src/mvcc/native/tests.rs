    ...
    connection
        .with(|connection| {
            ...
            let expected: BTreeSet<_> = NativeRecordFamily::all()
                .filter(|family| !matches!(family, NativeRecordFamily::TableOwners | NativeRecordFamily::GraphLookups | NativeRecordFamily::OccurrenceSkips | NativeRecordFamily::OccurrenceBlockMax | NativeRecordFamily::OccurrenceGuards | NativeRecordFamily::IVFGuards))
            ...
            for family in NativeRecordFamily::all() {
                ...
                if matches!(family, NativeRecordFamily::TableOwners | NativeRecordFamily::GraphLookups | NativeRecordFamily::OccurrenceSkips | NativeRecordFamily::OccurrenceBlockMax | NativeRecordFamily::OccurrenceGuards | NativeRecordFamily::IVFGuards) { continue; }
