...
pub fn references_column(encoded: &str, column: &str) -> serde_json::Result<bool> {
...
pub fn rename_column(encoded: &str, from: &str, to: &str) -> serde_json::Result<Option<String>> {
