...
fn controlled_values_preserve_ordinary_numeric_and_tagged_representations() {
    for text in [
        ...
        "{}",
        r#"{"$uqa_type":"void"}"#,
        r#"{"$uqa_type":"float_bits","hex":"7ff0000000000000"}"#,
        r#"{"$uqa_type":"float_bits","hex":"fff8000000000001"}"#,
        r#"{"$uqa_type":"float_bits","hex":"3ff0000000000000"}"#,
        r#"{"$uqa_type":"float_bits","hex":"7ff0000000000000","extra":true}"#,
