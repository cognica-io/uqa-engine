...
The native Nori user-dictionary parser, rolling Viterbi search, and token emission in `src/nori/user_dictionary/`, `src/nori/user_dictionary.rs`, and `src/nori/tokenizer/` were ported from Apache Lucene 10.5.1, commit `64ce863a2bea79c69c19c4d56268c26710ff0ff9`. The original source is licensed under Apache-2.0; the complete upstream `LICENSE.txt` and `NOTICE.txt` are retained alongside this file.

The reference files are `lucene/analysis/common/src/java/org/apache/lucene/analysis/morph/Viterbi.java` and the Nori `Viterbi.java`, `KoreanTokenizer.java`, `Token.java`, `DecompoundToken.java`, `dict/UserDictionary.java`, and `dict/UserMorphData.java` under `lucene/analysis/nori/src/java/org/apache/lucene/analysis/ko/`. See the [pinned upstream tree](https://github.com/apache/lucene/tree/64ce863a2bea79c69c19c4d56268c26710ff0ff9/lucene/analysis).
