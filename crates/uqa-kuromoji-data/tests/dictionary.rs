...
use uqa_kuromoji_data::{BUNDLE, BUNDLE_SHA256, DICTIONARY_ID, MODEL_MANIFEST, RESOURCE_MANIFEST};

#[test]
fn embedded_bytes_match_the_packaged_identity_and_manifests() {
    assert_eq!(BUNDLE.len(), 6_654_306);
    ...
    assert_eq!(model["model"]["surface_count"], 325_872);
