...
fn linear_corpus() -> MemoryGraphStore {
    ...
    g.add_edge(Edge::new(10, 1, 2, "e"), "g");
    g.add_edge(Edge::new(11, 2, 3, "e"), "g");
    g.add_edge(Edge::new(12, 3, 4, "e"), "g");
    g
}
...
fn star_corpus() -> MemoryGraphStore {
    ...
    g.add_edge(Edge::new(10, 1, 2, "e"), "g");
    g.add_edge(Edge::new(11, 3, 2, "e"), "g");
    g.add_edge(Edge::new(12, 4, 2, "e"), "g");
    g
}
...
fn pagerank_assigns_higher_score_to_central_vertex_in_star() {
    let g = star_corpus();
    let result = PageRank::new("g").execute(&g);
...
fn betweenness_finds_bridge_vertex() {
    ...
    g.add_edge(Edge::new(10, 1, 2, "e"), "g");
    g.add_edge(Edge::new(11, 2, 3, "e"), "g");
    let result = BetweennessCentrality::new("g").execute(&g);
    let scores = score_map(&result);
