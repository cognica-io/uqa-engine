...
impl FunctionDispatch {
    ...
    /// Decode the compiler-private function spellings written into durable
    /// expressions by releases through 0.1.6. This is a catalog migration
    /// primitive, never a SQL routine lookup path.
    #[doc(hidden)]
    #[must_use]
