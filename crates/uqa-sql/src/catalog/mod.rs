...
impl VirtualRelation {
    ...
    pub fn schema(self) -> Vec<(String, ColumnType)> {
        ...
        match self {
            ...
            Self::InformationColumnPrivileges | Self::InformationRoleColumnGrants => columns![
...
pub fn information_schema_domains() -> Vec<ColumnType> {
    vec![
        cardinal_number(),
        character_data(),
        sql_identifier(),
