...
use super::{
    ...
    QueryPlan, RelationalPlan, SQLError, ScalarExpr, SourcePlan, ViewRewriteContext,
};
...
fn offset_expression_subquery_ids(expression: &mut ScalarExpr, offset: usize) {
    ...
    crate::plan::rewrite_scalar_expression(expression, &mut |node| match node {
...
pub(super) fn embed_layer_expression(
    ...
    let scope = services.catalog.binding_scope()?;
