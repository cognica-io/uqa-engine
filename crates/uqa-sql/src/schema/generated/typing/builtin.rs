...
fn range_subtype_type(subtype: crate::ast::RangeSubtype) -> GenerationType {
    match subtype {
        crate::ast::RangeSubtype::Integer => GenerationType::Integer,
        crate::ast::RangeSubtype::BigInteger => GenerationType::BigInteger,
        crate::ast::RangeSubtype::Numeric => GenerationType::Numeric,
        crate::ast::RangeSubtype::Date => GenerationType::Date,
        crate::ast::RangeSubtype::Timestamp => GenerationType::Timestamp,
        crate::ast::RangeSubtype::TimestampTz => GenerationType::TimestampTz,
    }
}

fn range_constructor_subtype(name: &str) -> Option<(crate::ast::RangeSubtype, bool)> {
