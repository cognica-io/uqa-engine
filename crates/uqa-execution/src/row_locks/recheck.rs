...
impl Default for RowLockRecheckPins {
    fn default() -> Self {
        Self::new()
    }
}
...
impl RowLockRecheckPins {
    ...
    pub fn source_row(&self, path: &[u8]) -> Option<RecheckSourceRow> {
        self.source_rows
            .iter()
    ...
    pub fn storage_pins_for_identity_source(
        &self,
        qualifier: &str,
...
pub fn recheck_storage_names_match(left: &str, right: &str) -> bool {
    if left == right {
        return true;
    }
