...
pub trait CommittedRowSource {
    fn get_committed_document(
        &self,
        table: &str,
...
impl RowLockRetryCache {
    ...
    pub fn set_snapshot_baseline(&self, baseline: crate::row_locks::RowChangeBaseline) {
    ...
    pub fn conflicting_change_target_since_snapshot(
        &self,
        table: &str,
        doc_id: uqa_core::DocId,
    ...
    pub fn committed_override(
        &self,
        source: &dyn CommittedRowSource,
        table: &str,
        ...
        let document = source.get_committed_document(table, target_doc_id)?;
