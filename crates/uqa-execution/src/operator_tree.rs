...
//! Physical operator-tree execution and timing.
//!
//! [`PlanExecutor`] is the runtime entry point for executing an
...
/// child execution, and the runtime context); the execution-owned
