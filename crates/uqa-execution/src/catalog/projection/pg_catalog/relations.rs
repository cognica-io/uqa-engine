...
pub fn table_relation_oid_from(
    catalog: &CatalogReadView,
    resolution: &RelationNameResolution,
    table: &str,
) -> Result<i64, SQLError> {
...
pub fn build_pg_matviews(
    ...
    let mut rows = Vec::new();
    for (name, stored) in catalog.views_of_kind(crate::catalog::view::StoredViewKind::Materialized)
    {
...
fn database_acl_catalog_value(
    security: &crate::catalog::security::DatabaseSecurity,
