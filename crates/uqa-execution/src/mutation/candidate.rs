...
pub struct MutationCandidate<C = ()> {
...
#[derive(Debug, Clone, PartialEq)]
pub struct MutationRewriteCandidate<C = ()> {
    pub identity: PhysicalDocumentIdentity,
...
pub enum PhysicalMutationLockTarget {
    Present {
...
pub struct PhysicalDocumentIdentity {
    pub table: String,
    pub doc_id: DocId,
}
