...
pub struct PreparedInsertSpillRow {
    pub target_table: String,
    pub document: Document,
    pub conflict: PreparedInsertConflict,
}

pub fn prepared_insert_spill_schema() -> RowSchema {
...
pub fn encode_prepared_insert_spill_row(prepared: PreparedInsertSpillRow) -> PhysicalRow {
...
pub fn decode_prepared_insert_spill_row(
