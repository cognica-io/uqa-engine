...
#[derive(Debug, Clone, PartialEq)]
pub struct PreparedDocumentInsert {
    pub table: String,
    pub doc_id: DocId,
    pub document: Document,
}
...
#[derive(Debug, Clone, PartialEq)]
pub enum PreparedMutationAction {
...
#[derive(Debug, Clone, PartialEq)]
pub enum PreparedInsertConflict {
    Unresolved,
...
pub fn encode_prepared_doc_id(doc_id: DocId) -> Value {
    Value::Bytes(doc_id.to_be_bytes().to_vec())
}

pub fn decode_prepared_doc_id(value: Value, context: &str) -> Result<DocId, SQLError> {
...
pub fn encode_prepared_document_rewrite(prepared: PreparedDocumentRewrite) -> Value {
...
pub fn decode_prepared_document_rewrite(value: Value) -> Result<PreparedDocumentRewrite, SQLError> {
...
pub fn decode_prepared_document_delete(value: Value) -> Result<PreparedDocumentDelete, SQLError> {
    let Value::Map(mut fields) = value else {
        return Err(SQLError::Internal(
...
pub fn encode_prepared_insert_conflict(prepared: PreparedInsertConflict) -> Value {
...
pub fn decode_prepared_insert_conflict(value: Value) -> Result<PreparedInsertConflict, SQLError> {
    let Value::Map(mut fields) = value else {
        return Err(SQLError::Internal(
...
pub fn encode_prepared_mutation_action(action: PreparedMutationAction) -> Value {
...
pub fn decode_prepared_mutation_action(value: Value) -> Result<PreparedMutationAction, SQLError> {
    let Value::Map(mut fields) = value else {
        return Err(SQLError::Internal(
