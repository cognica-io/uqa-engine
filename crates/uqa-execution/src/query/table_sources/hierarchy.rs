...
use crate::row_locks::recheck::RecheckDoc;
...
use uqa_sql::{
    ...
    semantics::{TABLE_OID_COLUMN, XMIN_COLUMN},
...
pub fn build_hierarchy_retrieval_operator<'a, S: Clone>(
    ...
    let physical_columns = uqa_sql::semantics::bound_source_column_names(
        catalog
    ...
    uqa_sql::plan::rewrite_scalar_expression(&mut physical_predicate, &mut |expression| {
