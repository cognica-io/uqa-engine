...
pub use type_resolution::{
    ...
    rank_function_matches, require_equality_operator, require_ordering_operator,
    ...
    FunctionCallArgumentSignature, FunctionParameterDescriptor, MatchedBuiltinFunction,
    MatchedFunctionSignature, MatchedRoutineSignature, RankedFunctionMatch,
