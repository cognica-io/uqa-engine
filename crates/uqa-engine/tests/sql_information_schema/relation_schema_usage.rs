...
fn relation_schema_fixture() -> Engine {
    ...
    for sql in [
        ...
        "GRANT SELECT ON TABLE relation_schema_visible.bound_view, relation_schema_visible.bound_matview TO relation_schema_caller",
        ...
        "CREATE TABLE relation_schema_visible.index_items(value integer)",
        "CREATE INDEX shared_schema_idx ON relation_schema_visible.index_items(value)",
        ...
        "RESET ROLE",
        "REVOKE USAGE, CREATE ON SCHEMA relation_schema_hidden FROM relation_schema_caller",
        "SET ROLE relation_schema_caller",
