...
#[path = "sql_merge.rs"]
mod sql_merge;
#[path = "catalog/sql_notifications.rs"]
...
#[path = "catalog/sql_relation_forms.rs"]
mod sql_relation_forms;
#[path = "catalog/sql_relation_hierarchy.rs"]
mod sql_relation_hierarchy;
#[path = "catalog/sql_rules.rs"]
mod sql_rules;
...
#[path = "catalog/sql_triggers.rs"]
mod sql_triggers;
#[path = "catalog/sql_type_migration_temporal.rs"]
