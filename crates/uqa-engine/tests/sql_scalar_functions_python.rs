...
//! Additional port of Python `test_scalar_functions.py`.
...
#[test]
fn greatest_least_nullif_python_cases() {
...
#[test]
fn string_functions_python_cases() {
    assert_eq!(
...
#[test]
fn math_functions_python_cases() {
...
#[test]
fn step7_string_functions_python_cases() {
    assert_eq!(
...
#[test]
fn octet_md5_format_regex_overlay_python_cases() {
