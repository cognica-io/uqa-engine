...
impl Engine {
    pub(crate) fn bind_stored_statement_source_columns(
        ...
        crate::events::visit_stored_statement_sources(statement, &mut |source| {
    ...
    pub(crate) fn remove_stored_statement_source_column_aliases(
        ...
        if changed {
            crate::events::copy_stored_source_column_shapes(&mut planned, statement)?;
        }
        Ok(changed)
    }
    ...
    pub(in crate::events) fn bind_rule_condition_column_dependencies(
        &self,
        condition: &mut Expr,
    ) -> Result<BTreeSet<RuleColumnDependency>, SQLError> {
    ...
    pub(in crate::events) fn bind_rule_action_column_dependencies(
        &self,
    ...
    pub(in crate::events) fn rewrite_rule_column_references(
        &self,
    ...
    pub(in crate::events) fn remove_rule_source_column_aliases(
        &self,
        definition: &mut uqa_sql::ast::CreateRule,
