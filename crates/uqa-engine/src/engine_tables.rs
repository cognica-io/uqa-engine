...
impl Engine {
    ...
    fn create_table_inner(
        ...
        let table = TableState {
            ...
            security: crate::engine_state::CatalogCell::new(TableSecurity {
            ...
            table_checks: crate::engine_state::CatalogCell::new(Vec::new()),
            foreign_keys: crate::engine_state::CatalogCell::new(Vec::new()),
            key_constraints: crate::engine_state::CatalogCell::new(Vec::new()),
            hierarchy: crate::engine_state::CatalogCell::new(
                uqa_sql::ast::TableHierarchy::default(),
            ),
