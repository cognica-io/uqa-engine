...
impl Engine {
    ...
    fn sequence_introspection_privilege(
        ...
        match access {
            SequenceAccess::Any => crate::sequence_security::role_can_view_sequence(
                &sequence.security,
                &current_user,
                &roles,
                &memberships,
            ),
            SequenceAccess::Select => crate::sequence_security::role_can_select_sequence(
                &sequence.security,
                &current_user,
                &roles,
                &memberships,
            ),
            SequenceAccess::ReadValue => crate::sequence_security::role_can_read_sequence_value(
                &sequence.security,
                &current_user,
                &roles,
                &memberships,
