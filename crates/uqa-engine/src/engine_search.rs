...
fn raw_bm25_params(mode: &ScoringMode) -> BM25Params {
    match mode {
...
fn block_max_scorer_fingerprint(params: BM25Params, stats: &IndexStats) -> String {
    format!(
