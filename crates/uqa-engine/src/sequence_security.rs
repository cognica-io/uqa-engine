...
impl Engine {
    ...
    pub(crate) fn role_has_sequence_table_privilege(
        ...
        let privilege = match privilege {
            crate::table_security::TableAclPrivilege::Select => AclPrivilege::Select,
            crate::table_security::TableAclPrivilege::Update => AclPrivilege::Update,
            crate::table_security::TableAclPrivilege::Insert
            | crate::table_security::TableAclPrivilege::Delete
            | crate::table_security::TableAclPrivilege::Truncate
            | crate::table_security::TableAclPrivilege::References
            | crate::table_security::TableAclPrivilege::Trigger
            | crate::table_security::TableAclPrivilege::Maintain => return Ok(false),
        };
        let security = self
            .durable
            .sequence_security
