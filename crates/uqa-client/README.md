...
The development branch adds [data-modifying CTEs](https://github.com/cognica-io/uqa-engine/blob/main/docs/manual/sql/03-queries-and-dml.md#data-modifying-ctes) and the Rust [Simple Query API with PostgreSQL command completion](https://github.com/cognica-io/uqa-engine/blob/main/docs/manual/reference/02-rust-engine-api.md#simple-query-messages). These changes are recorded under [Unreleased](https://github.com/cognica-io/uqa-engine/blob/main/HISTORY.md#unreleased).
