...
```sh
npm install --omit=optional @cognica-io/uqa@0.3.0
```
...
See the [UQA Engine manual](https://github.com/cognica-io/uqa-engine/blob/v0.3.0/docs/manual/reference/08-bindings-and-extensions.md) for the complete Node.js binding contract.
