...
```sh
npm install --omit=optional @cognica-io/uqa@0.2.2
```
...
See the [UQA Engine manual](https://github.com/cognica-io/uqa-engine/blob/v0.2.2/docs/manual/reference/08-bindings-and-extensions.md) for the complete Node.js binding contract.

For existing installations, read the [0.2.2 upgrade guide](https://github.com/cognica-io/uqa-engine/blob/v0.2.2/docs/manual/reference/10-upgrading.md).
