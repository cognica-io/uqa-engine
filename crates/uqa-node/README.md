...
```sh
npm install --omit=optional @cognica-io/uqa@0.3.7
```
...
See the [UQA Engine manual](https://github.com/cognica-io/uqa-engine/blob/v0.3.7/docs/manual/reference/08-bindings-and-extensions.md) for the complete Node.js binding contract.

For existing installations, read the [0.3.7 upgrade guide](https://github.com/cognica-io/uqa-engine/blob/v0.3.7/docs/manual/reference/10-upgrading.md).
